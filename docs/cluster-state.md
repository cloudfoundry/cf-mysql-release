...
<pre class="terminal">
$ mysql -h NODE_IP -u root -pPASSWORD -e 'SHOW GLOBAL VARIABLES LIKE "wsrep_cluster_status";'
+----------------------+---------+
| Variable_name        | Value   |
+----------------------+---------+
...
<pre class="terminal">
$ mysql -h NODE_IP -u root -pPASSWORD -e 'SHOW GLOBAL VARIABLES LIKE "wsrep_cluster_size";'
+--------------------+-------+
| Variable_name      | Value |
+--------------------+-------+
