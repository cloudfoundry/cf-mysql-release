...
var _ = Feature("CF MySQL Failover", func() {
	var appName string
	var broker_0_ssh_tunnel = IntegrationConfig.Brokers[0].SshTunnel
	var broker_1_ssh_tunnel = IntegrationConfig.Brokers[1].SshTunnel
	var broker_0_local_ip = IntegrationConfig.Brokers[0].Ip
